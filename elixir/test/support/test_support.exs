defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          codex_linear_graphql_enabled: true,
    ...
    codex_linear_graphql_enabled = Keyword.get(config, :codex_linear_graphql_enabled)
    ...
    sections =
      [
        ...
        "  adapter_module: #{yaml_value(Keyword.get(config, :tracker_adapter_module))}",
        ...
        "  linear_graphql_enabled: #{yaml_value(codex_linear_graphql_enabled)}",
