defmodule SymphonyElixir.Orchestrator do
    ...
    case Tracker.fetch_issue_states_by_ids(candidate_ids) do
      {:ok, refreshed_issues} ->
        ...
        Enum.reduce(candidates, state, fn issue, state_acc ->
          process_refreshed_issue(Map.fetch(refreshed_issues_map, issue.id), issue, state_acc, terminal_states)
        end)
  ...
  defp process_refreshed_issue({:ok, %Issue{} = refreshed_issue}, _original_issue, state_acc, terminal_states) do
  ...
  defp process_refreshed_issue(:error, original_issue, state_acc, _terminal_states) do
