defmodule SymphonyElixir.Codex.AppServer do
  ...
  defp handle_decoded(
    ...
    emit_turn_event(:turn_completed, payload, payload_string, payload, state)
    {:ok, :turn_completed}
  end
  ...
  defp handle_decoded(
    ...
    emit_turn_event(:turn_failed, payload, payload_string, params, state)
  ...
  defp handle_decoded(
    ...
    emit_turn_event(:turn_cancelled, payload, payload_string, params, state)
  ...
  defp handle_decoded(
    ...
    emit_message(
      ...
      metadata_from_message(state.port, payload)
    )
  ...
  defp handle_decoded(
    ...
    emit_message(
      ...
      metadata_from_message(state.port, %{raw: payload_string})
    )

    receive_loop("", state)
  end

  defp emit_turn_event(event, payload, payload_string, payload_details, state) do
    emit_message(
      state.on_message,
      event,
      %{
  ...
  defp handle_turn_method(
    ...
    metadata = metadata_from_message(state.port, payload)
  ...
  defp maybe_handle_approval_request(
    ...
    emit_message(state.on_message, event, %{payload: payload, raw: payload_string}, metadata)
  ...
  defp approve_or_require(
         ...
         payload_string,
         metadata,
         %{auto_approve_requests: true} = state
       ) do
    send_message(state.port, %{"id" => id, "result" => %{"decision" => decision}})
  ...
  defp maybe_auto_answer_tool_request_user_input(
    ...
    case tool_request_user_input_approval_answers(params) do
      {:ok, answers, decision} ->
        send_message(state.port, %{"id" => id, "result" => %{"answers" => answers}})
